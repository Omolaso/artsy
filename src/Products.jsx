...
export const allProducts = [
  ...
  { name: "Young Girl", creator: "Ali Dawa", id: 3, url: `${homepageSlide3}` },
  { name: "Kangaroo", creator: "Luke", id: 4, url: `${homepageSlide4}` },
  { name: "Fruit", creator: "Clearamane", id: 5, url: `${homepageSlide5}` },
  {
    name: "ROAD TO EGYPT",
    id: 28,
    price: "$10.00",
